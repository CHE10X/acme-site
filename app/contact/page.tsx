...
export const metadata: Metadata = {
  title: "Contact — Council10",
  description: "Get in touch with Council10 for product questions, early access, or partnership inquiries.",
};
  ...
  return (
    <div className="min-h-screen bg-[#1E2226] text-[#E6E6E6]">
      <main className="mx-auto max-w-[640px] px-6 py-16">
        <div className="text-[10px] uppercase tracking-[0.4em] text-[#D98A2B] mb-2">Council10</div>
