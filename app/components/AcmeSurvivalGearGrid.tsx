...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    positioning:
      "Agent911 unifies system stability, Sentinel protection activity, and fleet presence into one operational surface — so you know what your agents are doing, and when to act.",
    bullets: [
    ...
    doesNot: ["does NOT mutate config / no automatic recovery / human-in-the-loop only"],
    optionalOutputs: "Observational by design. No automatic changes.",
...
const FIELD_UNITS: FieldUnit[] = [
  {
    id: "infrawatch",
    title: "InfraWatch",
    unitLabel: "INFRA DRIFT UNIT",
    subtitle: "Config drift detection under live load.",
    bullets: [
      "daemon + route config snapshots",
      "launchd + service deviation flags",
