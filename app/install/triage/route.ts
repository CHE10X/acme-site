...
// Served by: curl -fsSL https://council10.com/install/triage | bash
// Delegates to the public octriageunit installer in acmeagentsupply/triage.

const INSTALL_SCRIPT = `#!/usr/bin/env bash
# Triage — installer
# https://council10.com/install/triage
#
# Usage:
#   curl -fsSL https://council10.com/install/triage | bash
#   curl -fsSL https://council10.com/install/triage | bash -s -- --user
#
