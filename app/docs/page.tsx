  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-3 text-[10px] uppercase tracking-[0.4em] text-zinc-500">
          Launch Docs
        </div>
        <div className="space-y-3">
          {LAUNCH_DOCS.map((doc) => (
            <Link
              key={doc.href}
              href={doc.href}
              className="group block rounded-xl border border-zinc-800 bg-zinc-900/60 px-5 py-4 transition-colors hover:border-zinc-700 hover:bg-zinc-900"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="mt-1 text-sm text-zinc-400">{doc.desc}</div>
                </div>
        ...
        <div className="mt-10 pt-8 border-t border-zinc-800/60">
          ...
          <div className="space-y-2">
            <Link
              ...
              className="group flex items-center gap-3 text-sm text-zinc-400 hover:text-zinc-200 transition-colors"
            >
