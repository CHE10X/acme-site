...
RadCheck is free. No account required.

```bash
curl -fsSL https://acmeagentsupply.com/install/radcheck | bash
```

**License:** [ACME Freeware License](/legal/radcheck-license) — free to use, not free to fork or redistribute.
...
```bash
python3 ~/.openclaw/watchdog/radiation_check.py
```
