...
| InfraWatch | Session-to-session behavioral delta |
...
<CardGroup cols={2}>
  ...
  <Card title="Recall" icon="hand" href="/products/recall/overview">
    Direct intervention when automated monitoring needs a human decision.
  </Card>
